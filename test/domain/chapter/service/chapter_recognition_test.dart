...
void main() {
  test('Basic Ch prefix', () {
    const String mangaTitle = "Mokushiroku Alice";
  ...
  test('Name containing one number', () {
    const String mangaTitle = "Bleach";
  ...
  test('Chapter containing manga title and number', () {
    const String mangaTitle = "Solanin";
  ...
  test('Extreme case', () {
    const String mangaTitle = "Onepunch-Man";
  ...
  test('Version attached to chapter number', () {
    const String mangaTitle = "Ansatsu Kyoushitsu";
  ...
  test('Number after manga title with chapter in chapter title case', () {
    const String mangaTitle = "Tokyo ESP";
  ...
  test('Chapter title containing extra and vol', () {
    const String mangaTitle = "Fairy Tail";
  ...
  test('Chapter title containing commas', () {
    const String mangaTitle = "One Piece";
  ...
  test('Chapter title containing hyphens', () {
    const String mangaTitle = "Solo Leveling";
  ...
  test('Chapters containing ordinals', () {
    const String mangaTitle = "The Sister of the Woods with a Thousand Young";
