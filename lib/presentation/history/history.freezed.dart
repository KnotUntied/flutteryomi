...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( DateTime date)  header,required TResult Function( HistoryWithRelations item)  item,}) => throw _privateConstructorUsedError;
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( DateTime date)?  header,TResult? Function( HistoryWithRelations item)?  item,}) => throw _privateConstructorUsedError;
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( DateTime date)?  header,TResult Function( HistoryWithRelations item)?  item,required TResult orElse(),}) => throw _privateConstructorUsedError;
...
abstract class $HistoryUiModelCopyWith<$Res>  {
  factory $HistoryUiModelCopyWith(HistoryUiModel value, $Res Function(HistoryUiModel) then) = _$HistoryUiModelCopyWithImpl<$Res, HistoryUiModel>;
...
/// @nodoc
class _$HistoryUiModelCopyWithImpl<$Res,$Val extends HistoryUiModel> implements $HistoryUiModelCopyWith<$Res> {
...
/// @nodoc
class __$$HeaderImplCopyWithImpl<$Res> extends _$HistoryUiModelCopyWithImpl<$Res, _$HeaderImpl> implements _$$HeaderImplCopyWith<$Res> {
...
@override
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( DateTime date)  header,required TResult Function( HistoryWithRelations item)  item,}) {
  return header(date);
}
@override
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( DateTime date)?  header,TResult? Function( HistoryWithRelations item)?  item,}) {
  return header?.call(date);
}
@override
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( DateTime date)?  header,TResult Function( HistoryWithRelations item)?  item,required TResult orElse(),}) {
  if (header != null) {
    return header(date);
  }
  return orElse();
...
/// @nodoc
class __$$ItemImplCopyWithImpl<$Res> extends _$HistoryUiModelCopyWithImpl<$Res, _$ItemImpl> implements _$$ItemImplCopyWith<$Res> {
...
@override final  HistoryWithRelations item;
