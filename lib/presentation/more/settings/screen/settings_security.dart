...
//TODO
class ISettingsSecurityScreen extends ISearchableSettings {
  const ISettingsSecurityScreen();
  @override
  String getTitle(BuildContext context) =>
      AppLocalizations.of(context).pref_category_security;

  @override
  Widget getWidget() => const SettingsSecurityScreen();
...
class SettingsSecurityScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    const i = ISettingsSecurityScreen();
