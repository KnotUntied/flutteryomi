...
//TODO
class ISettingsBrowseScreen extends ISearchableSettings {
  const ISettingsBrowseScreen();
  @override
  String getTitle(BuildContext context) => AppLocalizations.of(context).browse;

  @override
  Widget getWidget() => const SettingsBrowseScreen();
