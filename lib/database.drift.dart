...
import 'package:flutteryomi/models/views/updatesView.drift.dart' as i3;
import 'package:flutteryomi/models/tables/history.drift.dart' as i4;
import 'package:flutteryomi/models/tables/categories.drift.dart' as i5;
import 'package:flutteryomi/models/tables/mangas_categories.drift.dart' as i6;
...
abstract class $AppDatabase extends i0.GeneratedDatabase {
  ...
  late final i4.History history = i4.History(this);
  late final i5.Categories categories = i5.Categories(this);
  ...
  i5.CategoriesDrift get categoriesDrift => i11.ReadDatabaseContainer(this)
      .accessor<i5.CategoriesDrift>(i5.CategoriesDrift.new);
  i2.ChaptersDrift get chaptersDrift => i11.ReadDatabaseContainer(this)
      .accessor<i2.ChaptersDrift>(i2.ChaptersDrift.new);
  i4.HistoryDrift get historyDrift => i11.ReadDatabaseContainer(this)
      .accessor<i4.HistoryDrift>(i4.HistoryDrift.new);
  ...
  i3.UpdatesViewDrift get updatesViewDrift => i11.ReadDatabaseContainer(this)
