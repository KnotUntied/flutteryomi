...
import 'package:flutteryomi/models/views/libraryView.drift.dart' as i1;
import 'package:flutteryomi/models/tables/mangas.drift.dart' as i2;
import 'package:drift/internal/modular.dart' as i3;
import 'package:flutteryomi/models/tables/chapters.drift.dart' as i4;
import 'package:flutteryomi/models/tables/history.drift.dart' as i5;
...
class LibraryView extends i0.ViewInfo<i1.LibraryView, i1.LibraryViewData>
  ...
  Set<String> get readTables =>
      const {'mangas', 'chapters', 'history', 'mangas_categories'};
}
...
class LibraryViewDrift extends i3.ModularAccessor {
  ...
  i6.MangasCategories get mangasCategories =>
      this.resultSet<i6.MangasCategories>('mangas_categories');
}
