...
mixin _$UpdatesWithRelations {
  ...
  String get mangaTitle => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $UpdatesWithRelationsCopyWith<UpdatesWithRelations> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdatesWithRelationsCopyWith<$Res> {
  factory $UpdatesWithRelationsCopyWith(UpdatesWithRelations value,
          $Res Function(UpdatesWithRelations) then) =
      _$UpdatesWithRelationsCopyWithImpl<$Res, UpdatesWithRelations>;
  @useResult
  $Res call(
      {int mangaId,
      String mangaTitle,
...
/// @nodoc
class _$UpdatesWithRelationsCopyWithImpl<$Res,
        $Val extends UpdatesWithRelations>
    implements $UpdatesWithRelationsCopyWith<$Res> {
    ...
    return _then(_value.copyWith(
      mangaId: null == mangaId
          ...
          : mangaId // ignore: cast_nullable_to_non_nullable
              as int,
      mangaTitle: null == mangaTitle
          ? _value.mangaTitle
          : mangaTitle // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
abstract class _$$UpdatesWithRelationsImplCopyWith<$Res>
    implements $UpdatesWithRelationsCopyWith<$Res> {
  factory _$$UpdatesWithRelationsImplCopyWith(_$UpdatesWithRelationsImpl value,
          $Res Function(_$UpdatesWithRelationsImpl) then) =
      __$$UpdatesWithRelationsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int mangaId,
...
/// @nodoc
class __$$UpdatesWithRelationsImplCopyWithImpl<$Res>
    extends _$UpdatesWithRelationsCopyWithImpl<$Res, _$UpdatesWithRelationsImpl>
    implements _$$UpdatesWithRelationsImplCopyWith<$Res> {
  __$$UpdatesWithRelationsImplCopyWithImpl(_$UpdatesWithRelationsImpl _value,
      $Res Function(_$UpdatesWithRelationsImpl) _then)
      : super(_value, _then);
...
class _$UpdatesWithRelationsImpl implements _UpdatesWithRelations {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdatesWithRelationsImpl &&
            (identical(other.mangaId, mangaId) || other.mangaId == mangaId) &&
            (identical(other.mangaTitle, mangaTitle) ||
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdatesWithRelationsImplCopyWith<_$UpdatesWithRelationsImpl>
      get copyWith =>
          __$$UpdatesWithRelationsImplCopyWithImpl<_$UpdatesWithRelationsImpl>(
              this, _$identity);
}
...
abstract class _UpdatesWithRelations implements UpdatesWithRelations {
  const factory _UpdatesWithRelations(
      ...
      required final int lastPageRead,
      required final int sourceId,
      required final DateTime dateFetch,
      required final MangaCover coverData}) = _$UpdatesWithRelationsImpl;
