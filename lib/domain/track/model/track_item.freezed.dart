...
/// @nodoc
mixin _$TrackItem {
  MangaSyncData? get track => throw _privateConstructorUsedError;
...
abstract class $TrackItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({MangaSyncData? track, Tracker tracker});
}
...
abstract class _TrackItem implements TrackItem {
  const factory _TrackItem(
      {final MangaSyncData? track,
      required final Tracker tracker}) = _$TrackItemImpl;

  @override
  MangaSyncData? get track;
  @override
  Tracker get tracker;
  @override
  @JsonKey(ignore: true)
