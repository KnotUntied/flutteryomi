...
class EpubPageLoader extends PageLoader {
  EpubPageLoader(this.channel);

  final InputStreamBase channel;
  late final _epub = ZipDecoder().decodeBuffer(channel);

  @override
  bool get isLocal => true;

  @override
  Future<List<ReaderPage>> getPages() async => _epub.files
      .where((it) {
